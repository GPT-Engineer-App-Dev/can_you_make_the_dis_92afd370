...
import { Box, Heading, Table, Thead, Tbody, Tr, Th, Td, VStack, HStack, Icon, Input, Button, ButtonGroup, useBreakpointValue } from "@chakra-ui/react";
...
const Index = () => {
  ...
  return (
    <VStack spacing={8} p={{ base: 2, md: 5 }}>
      {isMobile ? (
        <MobileNav currentHole={currentHole} setCurrentHole={setCurrentHole} />
      ) : (
        <>
